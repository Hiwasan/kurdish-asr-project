...
A research project developing ASR technology for Kurdish language dialects, building on 23 years of specialized linguistic fieldwork and computational linguistics expertise.

## Project Vision

This project addresses the critical gap in speech recognition technology for Kurdish languages by creating a robust ASR system that captures the rich dialectal variations and linguistic complexity of Kurdish speech.

## Project Leadership

**Principal Investigator: Dr. Hiwa Asadpour**

- 23-year Kurdish dialectal corpus and fieldwork expertise
- Domain expertise in Kurdish phonology, morphology, syntax, and dialectal variation
- Specialist in text processing, annotation, and Universal Dependencies (UD) treebank development
- Experience in computational linguistics and linguistic data engineering
- Contributions to applied NLP for under-resourced languages in Western Asia
...
*Note: Due to the sensitive and proprietary nature of the linguistic data, the actual corpus is stored in secure, access-controlled environments.*
...
- Model Architecture: State-of-the-art transformer-based ASR models adapted for Kurdish
...
- Project structure and development framework
- Sample data preparation and access protocols
...
*Important: The linguistic corpus data is proprietary and subject to separate access agreements.*

## Project Context

This ASR project is developed by Dr. Hiwa Asadpour as part of broader academic research initiatives in minority language preservation and speech technology.

## Contact

For project inquiries or collaboration discussions:
Dr. Hiwa Asadpour: asadpourhiwa@gmail.com

---

*Revision Note: This README has been updated to reflect current project leadership and remove references to former collaborators following confidentiality concerns. Previous versions documented collaborative contributions that are no longer active.*
