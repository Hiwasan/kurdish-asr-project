...
'''bash
# Clone repository
git clone https://github.com/hiwasan/kurdish-asr-project.git
cd kurdish-asr-project

# Install dependencies
pip install -r requirements.txt

# Data access setup (see data/README.md)
'''
...
python scripts/evaluate.py --model baseline --test-set sample
'''
